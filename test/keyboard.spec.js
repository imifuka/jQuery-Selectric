...
describe('keyboard', function () {
  ...
  it('should close without selecting on tab keypress', function () {
    $('.selectric').click();
    ...
    kb.down('tab');
    expect($('.selectric-items').is(':visible')).toBe(false);
    expect(select.val()).toBe(initialValue);
  });

  it('should close without selecting on esc keypress', function () {
    $('.selectric').click();
    var initialValue = select.val();
    var inputElm = document.activeElement;
    var kb = keyvent.on(inputElm);
